namespace SDK
{
    public readonly partial struct ClassNames
    {
        ...
        {
            public const uint ClassName_ClassToken = 0x2001BEF; // MDToken
            public const uint GetMalfunctionState_MethodToken = 0x600AE18; // MDToken
        ...
        {
            public const uint ClassName_ClassToken = 0x200323B; // MDToken
            public const string ClassName = @"\uF0B2";
        }

        public readonly partial struct ProceduralWeaponAnimation
        {
            public const uint ClassName_ClassToken = 0x200264D; // MDToken
            public const uint MethodName_MethodToken = 0x600EF43; // MDToken
    ...
    public readonly partial struct Offsets
    {
        ...
        {
            public const uint LocationId = 0x98; // String
